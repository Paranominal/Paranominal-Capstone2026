...
public class WeaponEvents : MonoBehaviour
{
    ...
    public event Action<WeakPointType, ShotOutcome> ShotResolved;
    ...
    public void RaiseShotResolved(WeakPointType shotType, ShotOutcome outcome) => ShotResolved?.Invoke(shotType, outcome);
