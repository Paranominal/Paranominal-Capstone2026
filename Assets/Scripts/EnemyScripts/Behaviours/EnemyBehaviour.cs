// Summary:
// Ground enemy behaviour using NavMeshAgent for movement. Extends EnemyBehaviourBase with NavMesh-specific chase, retreat, strafe, and return.
...
public class EnemyBehaviour : EnemyBehaviourBase
{
    ...
    protected override void InitializeMovement()
    {
        ...
        if (navAgent != null) navAgent.acceleration = 51f - chaseEasing * 50f;
    }
