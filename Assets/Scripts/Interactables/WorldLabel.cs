...
// Summary: Anchor for world-space labels. Place on a child object to define the label position. Mode determines presentation behaviour:
...
// The InteractionFocusController finds these via proximity and feeds them to the WorldLabelPool.
